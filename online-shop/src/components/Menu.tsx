import { LogoIcon, ProfileMenuIcon, MenuArrowDownIcon, BagpackMenuIcon, LogoIconBlack, ProfileMenuBlack, MenuArrowDownBlack, BagpackMenuBlack } from '@/images/icons';
